...
@section('title-container')
    <h4 class="m-0 text-dark text-uppercase">GRÁFICAS LLAMADAS NODOS (Acumulado Día)</h4> 
@endsection
...
@section('content')
    ...
    <div class="row">
        ...
        <div class="tab-content w-100" id="tabsGraficaLlamadasNodosDiaContent">
            <div class="tab-pane fade show   active" id="graficaLlamadasNodosDiaTab" role="tabpanel" aria-labelledby="graficaLlamadasNodosDiaTab-tab">
                <section  class="col-12 mx-0 px-0">
                    ...
                    <div class="cad">
                        <div class="card-body position-relative" id="contenedor_grafica_llamadas_nodos_dia_body">
                            <div class="content_table_list">
                                <section class="row my-3 py-2 content_filter_basic" id="contentFiltroGraficaLlamadasNodosDia" style="display:none">
                                            ...
                                            <div class="form-group row mx-0 mb-0 px-2 col-12 col-sm-12 col-md-12 col-lg-12 justify-content-center">
                                                <a href="javascript:void(0)" class="btn btn-sm btn-primary shadow-sm w-25" id="filtroGraficaLlamadasNodosDia">Filtrar</a>
                                            </div>
                                </section>
                                <div class="buttom-flex-end" id="averiasJefTabFiltro">
                                    <div class="btn-group">
                                        <button class="btn btn-secondary btn-margin-right btn-sm btn-info filtro-grafica-llamadas-nodos-dia" tabindex="0" aria-controls="resultSaturacionDown" type="button" title="FILTROS EN GRAFICA LLAMADAS DIA">
                                            <span>FILTROS</span>
                                        </button> 
                                    </div>
                                </div>
                                <section  class="col-12 mx-0 px-0">
                                    <div class="card">
                                        ...
                                        <div class="card-body"> 
                                            <div id="contencionGraficaLlamadasNodosDia" class="row text-sm"></div>
                                        </div>
                                    </div>
                                </section>
                            </div>
...
@section('scripts-footer')   
    ...
    <script src="{{ url('/js/sistema/modulos/grafica-llamadas-nodos-dia/edit.min.js') }}"></script>
    <script src="{{ url('/js/sistema/modulos/grafica-llamadas-nodos-dia/index.min.js') }}"></script>
