...
$(function(){
    ...
    $("body").on("click",".verMapa", function(){
        ...
        $("#mapa_content_monitor_averias").html(`<div id="carga_person">
                                                    <div class="loader">Loading...</div>
                                                </div>`);
        
         $.ajax({
            url:"/administrador/monitor-averias/mapa/view",
            method:"get",
            data:{
                n:n,
                t:t,
        ...
        .done(function(data){
           //console.log("El resultado es:",data)  
            let mapa = JSON.parse(data.response.html)
             $("#mapa_content_monitor_averias").html(mapa)
        })
        .fail(function(jqXHR, textStatus){
             //console.log( "Error: " + jqXHR, textStatus); 
             // $("#mapa_content_monitor_averias").html(jqXHR.responseText)
             //   return false
            let erroresPeticion =""
            ...
            $("#mapa_content_monitor_averias").html(erroresPeticion)
    ...
    $("body").on("click",".show_edificio_details", function(){ 
        ...
        peticiones.redirectTabs($('#monitorAvEdificiosTab'))
        ...
        let des_puer = $(this).data("numpuer")
          ...
          $('#edificios_content_multiconsulta').DataTable({
                ...
                "ajax": {  
                    'url':'/administrador/monitor-averias/mapa/edificios/view',
                    "type": "GET", 
                    "data": function ( d ) {
