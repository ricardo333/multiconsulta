...
$(function(){
    ...
    loadOptionsEstadoSelect($("#estadoStore").val() || "")

    $("body").on("click",".gestionarAveria", function(){

            peticiones.redirectTabs($('#gestionIndividualMonitorAveriasTab')) 
            ...
            $.ajax({
                url:`/administrador/monitor-averias/gestion/requires`,
                method:"get",
                data: {
                    numRequ,
                    nodo,
    ...
    $("#registrarGestIndiv").click(function(){
        ...
        $.ajax({
            url:`/administrador/monitor-averias/gestion-individual/store`,
            method:"post",
            data:dataEnviar,
            dataType: "json", 
        })
    ...
    $("body").on("click",".verDetalleGestion", function(){
        ...
        $.ajax({
            url:`/administrador/monitor-averias/gestion-individual/detalle`,
            method:"get", 
            data: { 
