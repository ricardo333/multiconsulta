...
//$('#caidasMasivasTab')
            gestionIndividual.loadRequires(`/administrador/caidas/gestion/requires`,parametros)
    ...
    $("#registrarGestIndiv").click(function(){
        ...
        gestionIndividual.registroGestionTroba(`/administrador/caidas/gestion-individual/store`,dataEnviar)
