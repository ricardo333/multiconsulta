...
$(function(){
    ...
    $("body").on("click",".gestionarTrabajoProg", function(){
            ...
            let parametros = {
                ...
                'estado':estado,
                'numRequ':numRequ,
                'modulo':"TrabajosProgramados",//No es obligatorio, es solo para este modulo
                'idttpp':idttpp,
            }
             //console.log("Los parametros load son: ",parametros)
            //$('#caidasMasivasTab')
            gestionIndividual.loadRequires(`/administrador/trabajos-programados/gestion/requires`,parametros)
    ...
    $("#registrarGestIndiv").click(function(){
        ...
        dataEnviar.modulo = "TrabajosProgramados"
        dataEnviar.idttpp = $("#IdTrabajoProgItemProcesar").val()
        ...
        gestionIndividual.registroGestionTroba(`/administrador/trabajos-programados/gestion-individual/store`,dataEnviar)
