...
$(function(){
    ...
    $("body").on("click",".verMapa", function(){
        ...
        $("#mapa_content_problema_senal").html(`<div id="carga_person">
                                                    <div class="loader">Loading...</div>
                                                </div>`);
        
         $.ajax({
            url:"/administrador/problema-senal/mapa/view",
            method:"get",
            data:{
                n:n,
                t:t,
        ...
        .done(function(data){
           //console.log("El resultado es:",data)  
            let mapa = JSON.parse(data.response.html)
             $("#mapa_content_problema_senal").html(mapa)
        })
        .fail(function(jqXHR, textStatus){
            ...
            $("#mapa_content_problema_senal").html(erroresPeticion)
    ...
    $("body").on("click",".show_edificio_details", function(){ 
        ...
        peticiones.redirectTabs($('#problemaAvEdificiosTab'))
        ...
        let des_puer = $(this).data("numpuer")
          ...
          $('#edificios_content_multiconsulta').DataTable({
                ...
                "ajax": {  
                    'url':'/administrador/problema-senal/mapa/edificios/view',
                    "type": "GET", 
                    "data": function ( d ) {
