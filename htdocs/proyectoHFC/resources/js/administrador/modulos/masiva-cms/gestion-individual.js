...
$(function(){
    ...
    $("body").on("click",".gestionarAveria", function(){
        ...
        peticiones.redirectTabs($('#gestionIndividualMasivaCmsTab')) 
        ...
        $.ajax({
            url:`/administrador/masiva-cms/gestion/requires`,
            method:"get",
            data: {
                numRequ,
                nodo,
    ...
    $("#registrarGestIndiv").click(function(){
        ...
        $.ajax({
            url:`/administrador/masiva-cms/gestion-individual/store`,
            method:"post",
            data:dataEnviar,
            dataType: "json", 
        })
        .done(function(data){
            ...
            //if (filtroMonitorHfcGpon == "monitor_averias_hfc") {
                ...
                parametersDataAverias.jefatura = $("#listaJefaturasMasivas").val() 
                parametersDataAverias.estado = $("#listaEstadosMasivas").val() 
                tabla = $('#resultMasivaCms')
            //} 

            if (tabla != "") {
                peticiones.cargaDataMasivaCms(COLUMNS_MONITOR_AVERIAS,COLUMNS_DEFS_MONITOR_AVERIAS,BUTTONS_MONITOR_AVERIAS,parametersDataAverias,tabla)
            }
    ...
    $("body").on("click",".verDetalleGestion", function(){
        ...
        $.ajax({
            url:`/administrador/masiva-cms/gestion-individual/detalle`,
            method:"get", 
            data: { 
