...
$(function(){
    ...
    $("#return_agenda_to_averias_coe_Tab").click(function(){
    ...
    function cargaPrincipalAgendaDetalles(accionAgenda="agendar"){
      ...
      let idCliente = document.getElementById("detalleAgendaSeleccionadaCoe").dataset.uno
      //let sw = $("#preAgendaMulti").data("dos")
      let sw = document.getElementById("detalleAgendaSeleccionadaCoe").dataset.dos
      //let nodo = $("#preAgendaMulti").data("tres")
      let nodo = document.getElementById("detalleAgendaSeleccionadaCoe").dataset.tres

      let accionCarga = accionAgenda

      console.log("La data principal de agenda detalle es: ",
                idCliente,",",sw,",",nodo
      )
      ...
      $.ajax({
        url:`/administrador/averias-coe/agenda/detalle`,
        method:"get",
        async: true,
        data:{
          idCliente,
      ...
      .done(function(data){ 
        ...
        console.log("la data inicial agenda es: ",data)
        ...
        data.response.data.forEach(el => {
          ...
          tabla += `<div class="form-group row mx-0 my-1 px-2 col-md-6">
                      ...
                      <span class="form-control form-control-sm col-sm-9 col-md-8 bg-secondary text-secondary-lectura">${el.codcli}</span>   
                    </div>
                    <div class="form-group row mx-0 my-1 px-2 col-md-6">
                      ...
                      <span class="form-control form-control-sm  col-sm-9 col-md-8 bg-secondary text-secondary-lectura">${el.servicio}</span>   
                    </div>
                    <div class="form-group row mx-0 my-1 px-2 col-md-6">
                      <label for="detalleCodCliente" class="col-sm-3 col-md-4 col-form-label col-form-label-sm mb-0 px-0">NODO: </label> 
                      <span class="form-control form-control-sm  col-sm-9 col-md-8 bg-secondary text-secondary-lectura">${el.nodo}</span>   
                    </div>
                    <div class="form-group row mx-0 my-1 px-2 col-md-6">
                      <label for="detallenombreCliente" class="col-sm-3 col-md-4 col-form-label col-form-label-sm mb-0 px-0">NOMBRE: </label> 
                      <span class="form-control form-control-sm  col-sm-9 col-md-8 bg-secondary text-secondary-lectura">${el.nameclient}</span>   
                    </div>
                    <div class="form-group row mx-0 my-1 px-2 col-md-12">
                      ...
                      <span class="form-control form-control-sm  col-sm-9 col-md-10 bg-secondary text-secondary-lectura">${el.DIREC_INST}</span>   
                    </div>
                    `
    ...
    $("body").on("click",".preAgendaMulti", function(){
        ...
        document.getElementById("detalleAgendaSeleccionadaCoe").dataset.uno = $(this).data("uno")
        document.getElementById("detalleAgendaSeleccionadaCoe").dataset.dos = $(this).data("dos")
        document.getElementById("detalleAgendaSeleccionadaCoe").dataset.tres = $(this).data("tres")
      ...
      function cargarTurnosYDiasGeneralesDisponibles(parametros)
      {
        ...
        $("#resultAgendaGrafico").html("")
          ...
          $.ajax({
            url:`/administrador/averias-coe/agenda/verificar-turno`,
            method:"get",
            async: true,
            data:parametros,
            cache: false, 
      ...
      //INICIO GRAFICO
        ...
        $("body").on("click","#reservarTurnoSeleccionado", function(){
         ...
         // let tipoDeAgenda = $("#tipoDeAgenda").val()
          ...
          $.ajax({
            url:`/administrador/averias-coe/agenda/verificar-cupos`,
            method:"get",
            async: true,
            data:{
               // tipoDeAgenda,
    ...
    $("body").on("click","#procesarPreagendaFormSend", function(){
      ...
      $.ajax({
        url:`/administrador/averias-coe/agenda/store`,
        method:"post",
        async: true,
        data:{
          telefonoFijo,
    ...
    function resetarReservaCupoNodo()
    {
      ...
      $.ajax({
        url:`/administrador/averias-coe/agenda/quitar-cupos`,
        method:"post",
        async: true,
        data:{
            tipoTurno,
