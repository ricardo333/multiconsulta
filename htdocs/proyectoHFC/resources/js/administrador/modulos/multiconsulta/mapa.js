...
$(function(){
    ...
    $(".return_multiMapTab").click(function(){
        peticiones.redirectTabs($('#multiMapTab')) 
    })
     
    $("#detalle_mapa").click(function(){
        ...
        $("#mapa_content_multiconsulta").html(`<div id="carga_person">
                                                    <div class="loader">Loading...</div>
                                                </div>`);
        
         $.ajax({
            url:"/administrador/multiconsulta/mapa/detalle",
            method:"get",
            data:{
                n:n,
                t:t,
        ...
        .done(function(data){
           // console.log("El resultado es:",data)  
            let mapa = JSON.parse(data.response.html)
             $("#mapa_content_multiconsulta").html(mapa)
        })
        .fail(function(jqXHR, textStatus){
            //console.log( "Error: " + jqXHR, textStatus); 
             //$("#mapa_content_multiconsulta").html(jqXHR.responseText)
            ...
            $("#mapa_content_multiconsulta").html(erroresPeticion)
    ...
    $("body").on("click",".show_edificio_details", function(){ 
       ...
       // console.log("debe mostrar los edificios...")
        peticiones.redirectTabs($('#multiEdificiosTab'))
        ...
        let des_puer = $(this).data("numpuer")
          ...
          $('#edificios_content_multiconsulta').DataTable({
                ...
                "ajax": {  
                    'url':'/administrador/multiconsulta/mapa/edificios/detalle',
                    "type": "GET", 
                    "data": function ( d ) {
