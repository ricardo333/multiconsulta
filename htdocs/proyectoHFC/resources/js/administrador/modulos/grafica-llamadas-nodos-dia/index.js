...
$(function(){
    ...
    $("#filtroGraficaLlamadasNodosDia").click(function(){
    ...
    //Filtro
    $(".filtro-grafica-llamadas-nodos-dia").click(function(){
      $("#contentFiltroGraficaLlamadasNodosDia").slideToggle()
    })
    ...
    $(".maxi_tab").click(function(){
        ...
        $("#tabsGraficaLlamadasNodosDiaContent").toggleClass("fullscreen");
        if ($("#tabsGraficaLlamadasNodosDiaContent").hasClass("fullscreen")) {
