...
import graficaLlamadasNodosDia from  "@/globalResources/modulos/grafico-nodos-barras.js"
...
peticiones.getListaNodos = function getListaNodos(jefatura,nodo,callBack)
{
    ...
    $.ajax({
        url:`/administrador/grafica-llamadas-nodos-dia/lista-nodos-graficas`,
        method:"get",
        async: true,
        data: {
          jefatura,
...
peticiones.cargandoPeticionPrincipal = function cargandoPeticionPrincipal()
{
        ...
        $("#contencionGraficaLlamadasNodosDia").html("");	
        ...
        peticiones.getListaNodos(jefatura,nodo,function(res){ 
          ...
          if (Object.keys(res.response.nodos).length === 0) {
            ...
            $("#contencionGraficaLlamadasNodosDia").html(`<div class="width-100"><h2 class="text-center text-primary"><b>Estimado usuario</b></h2>
            ...
            res.response.nodos.forEach(el => {
                ...
                let grafico = graficaLlamadasNodosDia.grafico(el.nodo)
