...
$(function(){
    ...
    $("#jefaturaIngresoAverias").change(function(){
       // console.log("Se genero un change en el select de jefaturas..")
        ...
        peticiones.cargaTrobasProjefatura(jefatura,function(res){ 
            ...
            $("#trobaIngresoAverias").html("")
            $("#trobaIngresoAverias").append(`<option value="">Todos</option>`)
            res.response.trobas.forEach(el => {
                $("#trobaIngresoAverias").append(`<option value="${el.clave}">${el.clave}</option>`)
            })
