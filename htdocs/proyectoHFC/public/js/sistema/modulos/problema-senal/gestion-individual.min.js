...
/***/ "./resources/js/administrador/modulos/problema-senal/gestion-individual.js":
/*!*********************************************************************************!*\
  !*** ./resources/js/administrador/modulos/problema-senal/gestion-individual.js ***!
  \*********************************************************************************/
/*! no exports provided */
...
/* harmony import */ var _peticiones_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./peticiones.js */ "./resources/js/administrador/modulos/problema-senal/peticiones.js");
...
$(function () {
  ...
  $("body").on("click", ".gestionarAveria", function () {
    _peticiones_js__WEBPACK_IMPORTED_MODULE_1__["default"].redirectTabs($('#gestionIndividualProblemaSenalTab')); //console.log("se deberia redireccionar...")
    ...
    $.ajax({
      ...
      if (data.error) {
        _peticiones_js__WEBPACK_IMPORTED_MODULE_1__["default"].redirectTabs($('#problemaSenalTab'));
  ...
  $("#registrarGestIndiv").click(function () {
    ...
    $.ajax({
      ...
      _peticiones_js__WEBPACK_IMPORTED_MODULE_1__["default"].redirectTabs($('#problemaSenalTab')); //peticiones.ultimoUpdateMoAv("/administrador/problema-senal/ultimo-update",$("#fecha_ultimo_maver_hfc"))
      ...
      if (tabla != "") {
        _peticiones_js__WEBPACK_IMPORTED_MODULE_1__["default"].cargaDataProblemaSenal(COLUMNS_MONITOR_AVERIAS, COLUMNS_DEFS_MONITOR_AVERIAS, BUTTONS_MONITOR_AVERIAS, parametersDataAverias, tabla);
      }
    }).fail(function (jqXHR, textStatus) {
      $("#formularioContenedorGestionInd").removeClass("d-none");
...
/***/ "./resources/js/administrador/modulos/problema-senal/peticiones.js":
/*!*************************************************************************!*\
  !*** ./resources/js/administrador/modulos/problema-senal/peticiones.js ***!
  \*************************************************************************/
...
peticiones.armandoColumnas = function armandoColumnas() {
  ...
  columnasContent.push({
    ...
    render: function render(data, type, row) {
      ...
      if (MAPA_PERMISO) {
        estructura += "<a href=\"javascript:void(0)\" data-uno=\"".concat(row.nodo, "\" data-dos=\"").concat(row.troba, "\" class=\"btn btn-sm  text-light verMapa\" alt=\"Ver Mapa\" title=\"Ver Mapa\">\n                                                                                <i class=\"icofont-google-map icofont-2x\"></i>\n                                                                            </a>");
      }

      estructura += "<a href=\"javascript:void(0)\" data-uno=\"".concat(row.nodo, "\" data-dos=\"").concat(row.troba, "\" class=\"verAlertasDown\" alt=\"ver alertas down\" title=\"ver alertas down\" style=\"color: black;\">\n                                                                            ").concat(row.troba, "\n                                                                        </a>\n                                                                    </div>");
      return estructura;
    }
  }, {
    data: 'trabajo_estado',
    ...
    data: 'troba',
    render: function render(data, type, row) {
      return "<div class=\"text-center\">\n                                                                    <span>".concat(row.averiaM1 == null ? "" : row.averiaM1, "</span>\n                                                                     / \n                                                                     <span>").concat(row.averiaCatv == null ? "" : row.averiaCatv, "</span>\n                                                                </div>");
    }
  }, {
    data: 'codmasiva'
  }, {
    ...
    render: function render(data, type, row) {
      ...
      if (data != null) {
        ...
        return _globalResources_tablas_columnas_js__WEBPACK_IMPORTED_MODULE_1__["default"].armandoEstadoGestionHtml(parametrosGestion);
...
peticiones.cargaDataProblemaSenal = function cargaDataProblemaSenal(COLUMNS_MONITOR_AVERIAS, COLUMNS_DEFS_MONITOR_AVERIAS, BUTTONS_MONITOR_AVERIAS, parametersDataAverias, tabla) {
  ...
  tabla.DataTable({
    ...
    "ajax": {
      ...
      "data": function data(d) {
        ...
        d.filtroEstado = parametersDataAverias.estado; //d.filtroHfcGpon = parametersDataAverias.filtroHfcGpon;
...
/***/ 74:
/*!***************************************************************************************!*\
  !*** multi ./resources/js/administrador/modulos/problema-senal/gestion-individual.js ***!
  \***************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\laragon\www\new_system\resources\js\administrador\modulos\problema-senal\gestion-individual.js */"./resources/js/administrador/modulos/problema-senal/gestion-individual.js");
