...
/***/ "./resources/js/administrador/modulos/problema-senal/index.js":
/*!********************************************************************!*\
  !*** ./resources/js/administrador/modulos/problema-senal/index.js ***!
  \********************************************************************/
/*! no exports provided */
...
$(function () {
  ...
  $("#filtroBasicoProblemas").click(function () {
    var jefatura = $("#listaJefaturasProblemas").val();
    var estado = $("#listaEstadosProblemas").val(); //resultProblemaSenal($('#resultMonitoreoAveriasHfc'),jefatura,estado,$("#display_filter_special").val())
  ...
  $("body").on("click", ".return_problemaSenal", function () {
    _peticiones_js__WEBPACK_IMPORTED_MODULE_0__["default"].redirectTabs($('#problemaSenalTab'));
  ...
  function resultProblemaSenal(tabla, jefatura, estado) {
    ...
    var COLUMNS_MONITOR_AVERIAS = _peticiones_js__WEBPACK_IMPORTED_MODULE_0__["default"].armandoColumnas();
    var BUTTONS_MONITOR_AVERIAS = [];
    BUTTONS_MONITOR_AVERIAS = BUTTONS_MONITOR_AVERIAS_HFC;
    var parametersDataAverias = {
      'jefatura': jefatura,
      'estado': estado //'filtroHfcGpon':filtroHfcGpon,

    };
    _peticiones_js__WEBPACK_IMPORTED_MODULE_0__["default"].cargaDataProblemaSenal(COLUMNS_MONITOR_AVERIAS, COLUMNS_DEFS_MONITOR_AVERIAS, BUTTONS_MONITOR_AVERIAS, parametersDataAverias, tabla);
  } //Maximizar
...
/***/ 70:
/*!**************************************************************************!*\
  !*** multi ./resources/js/administrador/modulos/problema-senal/index.js ***!
  \**************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\laragon\www\new_system\resources\js\administrador\modulos\problema-senal\index.js */"./resources/js/administrador/modulos/problema-senal/index.js");
