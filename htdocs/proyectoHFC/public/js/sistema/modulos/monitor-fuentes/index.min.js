...
/***/ "./resources/js/administrador/modulos/monitor-fuentes/index.js":
/*!*********************************************************************!*\
  !*** ./resources/js/administrador/modulos/monitor-fuentes/index.js ***!
  \*********************************************************************/
/*! no exports provided */
...
$(function () {
  ...
  $("#btnTotal").click(function () {
    var nodo = $("#listaNodosMFFilter").val() || null;
    var tipoBateria = $("#listaTipoBateriaMFFilter").val() || null;
    var estadoDeGestion = $("#listaEstadosMFilter").val() || null;
    var filtros = {
      nodo: nodo,
    ...
    var fecha = yyyy + '' + leadingZero(mm) + '' + leadingZero(dd) + '' + leadingZero(hh) + '' + leadingZero(mi) + '' + leadingZero(ss); //console.log(fecha);
    ...
    $.ajax({
      ...
      var errorMessage1 = jqXHR.status + ': ' + "Hubo un error en los datos, intente en un minuto por favor."; //$("#resultOpcionesMonitoreoFuentes").html(jqXHR.responseText)
      //return false
...
/***/ 121:
/*!***************************************************************************!*\
  !*** multi ./resources/js/administrador/modulos/monitor-fuentes/index.js ***!
  \***************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\laragon\www\new_system\resources\js\administrador\modulos\monitor-fuentes\index.js */"./resources/js/administrador/modulos/monitor-fuentes/index.js");
