...
/***/ "./resources/js/administrador/modulos/monitor-fuentes/grafico-fuentes.js":
/*!*******************************************************************************!*\
  !*** ./resources/js/administrador/modulos/monitor-fuentes/grafico-fuentes.js ***!
  \*******************************************************************************/
/*! no exports provided */
...
$(function () {
  ...
  $("body").on("click", ".verGraficoFuentePoder", function () {
    ...
    if (mac == null || mac == "" || mac == undefined) {
      ...
      $("#body-errors-modal").html("<div class=\"w-100 text-center text-danger\">No hay una gr\xE1fica disponible para esta fuente.</div>");
      $('#errorsModal').modal('show');
      return false;
    }

    _peticiones_js__WEBPACK_IMPORTED_MODULE_0__["default"].redirectTabs($('#graficoFuentesPoderTab'));
    ...
    $.ajax({
      ...
      var colores = data.response.coloresFuente;
      var chartDataFuentes = [{
        name: "Vol_ent",
        data: [],
      ...
      grafico_data.forEach(function (el) {
        //let date = new Date();
        var date = new Date("".concat(el.fechahora)); // console.log("la fecha es: ",el.fechahora, "=>",date,"-->",date.valueOf())
      ...
      Highcharts.chart("resultGraficoDownFuentes", {
        ...
        title: {
          text: "Gr\xE1fico de Fuente"
        },
        subtitle: {
          text: "<span>Centro de control Movistar1 </span><br><span> Monitoreo de Fuentes de Poder</span><br>  <span>  NODO - TROBA : ".concat(nodoTroba, " </span>")
        },
        xAxis: {
          type: 'datetime',
          title: {
...
/***/ 122:
/*!*************************************************************************************!*\
  !*** multi ./resources/js/administrador/modulos/monitor-fuentes/grafico-fuentes.js ***!
  \*************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\laragon\www\new_system\resources\js\administrador\modulos\monitor-fuentes\grafico-fuentes.js */"./resources/js/administrador/modulos/monitor-fuentes/grafico-fuentes.js");
