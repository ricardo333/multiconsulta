...
/***/ "./resources/js/administrador/modulos/multiconsulta/historico-niveles-trobas.js":
/*!**************************************************************************************!*\
  !*** ./resources/js/administrador/modulos/multiconsulta/historico-niveles-trobas.js ***!
  \**************************************************************************************/
/*! no exports provided */
...
$(function () {
  ...
  $("body").on("click", "#historico_niv_trobas", function () {
    ...
    _peticiones_js__WEBPACK_IMPORTED_MODULE_1__["default"].redirectTabs($('#historicoNivTrobasTab'));
    $.ajax({
      ...
      Highcharts.chart("resultHistoricoNivTrobas", {
        ...
        subtitle: {
          text: "<span>Centro de control Movistar1 </span><br><span> Las \xFAltimas 72 horas</span><br> <span> CMTS : ".concat(cmts, " | INTERFACE : ").concat(interf, " | NODO - TROBA : ").concat(nodoTroba, "</span>")
        },
        xAxis: {
          type: 'datetime',
          title: {
      ...
      $("#resultHistoricoNivTrobas").html(""); //console.log( "Error: " + jqXHR, textStatus); 
...
/***/ 35:
/*!********************************************************************************************!*\
  !*** multi ./resources/js/administrador/modulos/multiconsulta/historico-niveles-trobas.js ***!
  \********************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\laragon\www\new_system\resources\js\administrador\modulos\multiconsulta\historico-niveles-trobas.js */"./resources/js/administrador/modulos/multiconsulta/historico-niveles-trobas.js");
