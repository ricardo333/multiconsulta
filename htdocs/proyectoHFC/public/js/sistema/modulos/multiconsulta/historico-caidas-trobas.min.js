...
/***/ "./resources/js/administrador/modulos/multiconsulta/historico-caidas-trobas.js":
/*!*************************************************************************************!*\
  !*** ./resources/js/administrador/modulos/multiconsulta/historico-caidas-trobas.js ***!
  \*************************************************************************************/
/*! no exports provided */
...
$(function () {
  ...
  $("body").on("click", "#historico_caidas_trobas", function () {
    ...
    var nodoTroba = $(this).data("tres");
    var puertoCmts = cmts + inter;
    $("#resultHistoricoCaidasTrobas").html("<div id=\"carga_person\">\n                                                    <div class=\"loader\">Loading...</div>\n                                                </div>");
    _peticiones_js__WEBPACK_IMPORTED_MODULE_1__["default"].redirectTabs($('#historicoCaidaTrobasTab'));
    $.ajax({
      url: "/administrador/multiconsulta/historico/caidas/troba",
      method: "post",
      data: {
        puertoCmts: puertoCmts,
        nodoTroba: nodoTroba
      },
      dataType: "json"
    }).done(function (data) {
      ...
      var colores = data.response.coloresCaidas;
      ...
      var cmts = "";
      var interf = "";
      var nodoTroba = data.response.nodoTroba;
      ...
      Highcharts.chart("resultHistoricoCaidasTrobas", {
        ...
        subtitle: {
          text: "<span>Centro de control Movistar1 </span><br><span> Caidas Masivas de Cable modems</span><br> <span> Ultimos 15 d\xEDas</span><br/><span> CMTS : ".concat(cmts, " | INTERFACE : ").concat(interf, " | NODO - TROBA : ").concat(nodoTroba, " </span>")
        },
        xAxis: {
          type: 'datetime',
          title: {
      ...
      $("#resultHistoricoCaidasTrobas").html(""); //console.log( "Error: " + jqXHR, textStatus); 
...
/***/ 36:
/*!*******************************************************************************************!*\
  !*** multi ./resources/js/administrador/modulos/multiconsulta/historico-caidas-trobas.js ***!
  \*******************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\laragon\www\new_system\resources\js\administrador\modulos\multiconsulta\historico-caidas-trobas.js */"./resources/js/administrador/modulos/multiconsulta/historico-caidas-trobas.js");
