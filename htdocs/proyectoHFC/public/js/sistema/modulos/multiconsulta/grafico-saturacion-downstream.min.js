...
/***/ "./resources/js/administrador/modulos/multiconsulta/grafico-saturacion-downstream.js":
/*!*******************************************************************************************!*\
  !*** ./resources/js/administrador/modulos/multiconsulta/grafico-saturacion-downstream.js ***!
  \*******************************************************************************************/
/*! no exports provided */
...
/* harmony import */ var _peticiones_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./peticiones.js */ "./resources/js/administrador/modulos/multiconsulta/peticiones.js");
...
$(function () {
  ...
  $("body").on("click", "#graficoDownstream", function () {
    var cmts = $(this).data("uno");
    var inter = $(this).data("dos");
    _peticiones_js__WEBPACK_IMPORTED_MODULE_0__["default"].redirectTabs($('#graficoSaturacionDownsTab'));
    ...
    $.ajax({
      ...
      var down = data.response.down;
      var cantidadData = result[0].cant;
      var capacidad = parseInt(cantidadData) * 38;
      result.forEach(function (el) {
        var date = new Date("".concat(el.fecha_hora));
        chartData.push([date.valueOf(), el.uso]);
      });
      ...
      Highcharts.chart("resultGraficoDownSaturados", {
        ...
        subtitle: {
          text: "<span>CMTS : ".concat(cmts, " Puerto Down : ").concat(down, "</span> <br> <span>Cant Portadoras habilitadas : ").concat(cantidadData, " Capacidad : ").concat(capacidad, "Mbps</span><br><span>\xDALTIMOS 3 D\xCDAS</span>")
        },
        xAxis: {
          type: 'datetime',
          title: {
      ...
      _peticiones_js__WEBPACK_IMPORTED_MODULE_0__["default"].redirectTabs($('#multiconsultaTab'));
...
/***/ 28:
/*!*************************************************************************************************!*\
  !*** multi ./resources/js/administrador/modulos/multiconsulta/grafico-saturacion-downstream.js ***!
  \*************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\laragon\www\new_system\resources\js\administrador\modulos\multiconsulta\grafico-saturacion-downstream.js */"./resources/js/administrador/modulos/multiconsulta/grafico-saturacion-downstream.js");
