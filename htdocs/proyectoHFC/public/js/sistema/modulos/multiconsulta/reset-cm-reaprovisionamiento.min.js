...
/***/ "./resources/js/administrador/modulos/multiconsulta/reset-cm-reaprovisionamiento.js":
/*!******************************************************************************************!*\
  !*** ./resources/js/administrador/modulos/multiconsulta/reset-cm-reaprovisionamiento.js ***!
  \******************************************************************************************/
/*! no exports provided */
...
/* harmony import */ var _globalResources_modulos_cm_reaprovisionamiento_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @/globalResources/modulos/cm-reaprovisionamiento.js */ "./resources/js/globalResources/modulos/cm-reaprovisionamiento.js");
...
$(function () {
  ...
  $("#resetCmReaprovisionamiento").click(function () {
    ...
    var idCliente = $(this).data("uno");
    var idServicio = $(this).data("dos");
    var idProducto = $(this).data("tres");
    var idVenta = $(this).data("cuatro");
    var data = {
      idCliente: idCliente,
    ...
    _globalResources_modulos_cm_reaprovisionamiento_js__WEBPACK_IMPORTED_MODULE_0__["default"].resetCM(data, '/administrador/multiconsulta/reset-cm-reaprovisionamiento/detalle');
  });
});
...
/***/ "./resources/js/globalResources/modulos/cm-reaprovisionamiento.js":
/*!************************************************************************!*\
  !*** ./resources/js/globalResources/modulos/cm-reaprovisionamiento.js ***!
  \************************************************************************/
/*! exports provided: default */
...
var reaprovisionamiento = {};

reaprovisionamiento.resetCM = function resetCM(parametros, route) {
  var refreshAveriaCoe = parametros.refreshAveriaCoe;
  ...
  $.ajax({
    ...
    $("#body-success-modal").html("<div class=\"text-center text-secondary text-sm\">".concat(data.mensaje, "</div>"));
...
/* harmony default export */ __webpack_exports__["default"] = (reaprovisionamiento);

/***/ }),

/***/ 29:
/*!************************************************************************************************!*\
  !*** multi ./resources/js/administrador/modulos/multiconsulta/reset-cm-reaprovisionamiento.js ***!
  \************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\laragon\www\new_system\resources\js\administrador\modulos\multiconsulta\reset-cm-reaprovisionamiento.js */"./resources/js/administrador/modulos/multiconsulta/reset-cm-reaprovisionamiento.js");
