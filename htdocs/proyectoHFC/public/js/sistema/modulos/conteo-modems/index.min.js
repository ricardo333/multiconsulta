...
/***/ "./resources/js/administrador/modulos/conteo-modems/index.js":
/*!*******************************************************************!*\
  !*** ./resources/js/administrador/modulos/conteo-modems/index.js ***!
  \*******************************************************************/
/*! no exports provided */
...
/* harmony import */ var _peticiones_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./peticiones.js */ "./resources/js/administrador/modulos/conteo-modems/peticiones.js");
...
$(function () {
  ...
  function loadPrincipalConteoModems() {
    var columnasConteoModems = _peticiones_js__WEBPACK_IMPORTED_MODULE_0__["default"].armandoColumnasUno();
    var tabla = $("#resultConteoModems");
    _peticiones_js__WEBPACK_IMPORTED_MODULE_0__["default"].cargaConteoModemsLista(columnasConteoModems, tabla);
  } //Maximizar
...
/***/ "./resources/js/administrador/modulos/conteo-modems/peticiones.js":
/*!************************************************************************!*\
  !*** ./resources/js/administrador/modulos/conteo-modems/peticiones.js ***!
  \************************************************************************/
...
function procesandoResultadoLista(result) {
  for (var i = 0; i < result.length; i++) {
    result[i].cmts = "<span class=\"font-weight-bold\">".concat(result[i].cmts, "</span>");
    result[i]["interface"] = "<span class=\"font-weight-bold\">".concat(result[i]["interface"], "</span>");
    result[i].description = "<span class=\"font-weight-bold\">".concat(result[i].description, "</span>");
    result[i].sincroniz = "<span class=\"font-weight-bold\">".concat(result[i].sincroniz, "</span>");
    result[i].cm_offline = "<span class=\"font-weight-bold\">".concat(result[i].cm_offline, "</span>");
    result[i].total = "<span class=\"font-weight-bold\">".concat(result[i].total, "</span>");
  }
...
peticiones.cargaConteoModemsLista = function cargaConteoModemsLista(COLUMNS_CAIDAS, tabla) {
  ...
  tabla.DataTable({
    ...
    "ajax": {
      ...
      "type": "GET",
      "data": function data(d) {// d.filtroJefatura = parametersDataEstadosModems.jefatura;
      },
    ...
    'columnDefs': [{
      ...
      "targets": '_all',
      "orderable": false,
      //Quito el ordenamiento de la cabecera cuando se hace click
      "searchable": false
    }],
...
peticiones.cargandoPeticionPrincipal = function cargandoPeticionPrincipal() {
  var valorFiltroEspecial = $("#input-ConteoModemsTab").val(); //console.log(valorFiltroEspecial);

  var params = peticiones.getDataRequiredFilterConteoModems(valorFiltroEspecial); //peticiones.redirectTabs(params.redirect)
...
/***/ 99:
/*!*************************************************************************!*\
  !*** multi ./resources/js/administrador/modulos/conteo-modems/index.js ***!
  \*************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\laragon\www\new_system\resources\js\administrador\modulos\conteo-modems\index.js */"./resources/js/administrador/modulos/conteo-modems/index.js");
