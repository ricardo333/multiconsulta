...
/***/ "./resources/js/administrador/modulos/contencion-llamadas/index.js":
/*!*************************************************************************!*\
  !*** ./resources/js/administrador/modulos/contencion-llamadas/index.js ***!
  \*************************************************************************/
/*! no exports provided */
...
/* harmony import */ var _peticiones_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./peticiones.js */ "./resources/js/administrador/modulos/contencion-llamadas/peticiones.js");
...
$(function () {
  ...
  _peticiones_js__WEBPACK_IMPORTED_MODULE_0__["default"].cargandoPeticionPrincipal(); //Modales
...
/***/ "./resources/js/administrador/modulos/contencion-llamadas/peticiones.js":
/*!******************************************************************************!*\
  !*** ./resources/js/administrador/modulos/contencion-llamadas/peticiones.js ***!
  \******************************************************************************/
...
peticiones.cargandoPeticionPrincipal = function cargandoPeticionPrincipal() {
  ...
  $.ajax({
    ...
    $("#preloadGraph").html("");
    var colores = data.response.colorContencionLlamadas;
    var estado = data.response.estado;
    var resultContencion = data.response.resultHoraTotalContencion;
    var ok = resultContencion[0].total - resultContencion[0].contencion;
    ...
    if (estado) {
      ...
      Highcharts.chart("contencionLlamadasGrafico", {
        ...
        subtitle: {
          text: "<span>".concat(resultContencion[0].total, " Total de Llamadas DMPE</span><br> <span>").concat(ok, " No Alarmadas</span><br> <span> ").concat(resultContencion[0].contencion, " Llamadas contenidas</span>")
        },
        xAxis: {
...
/***/ 132:
/*!*******************************************************************************!*\
  !*** multi ./resources/js/administrador/modulos/contencion-llamadas/index.js ***!
  \*******************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\laragon\www\new_system\resources\js\administrador\modulos\contencion-llamadas\index.js */"./resources/js/administrador/modulos/contencion-llamadas/index.js");
