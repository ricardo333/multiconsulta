...
/***/ "./resources/js/administrador/modulos/masiva-cms/index.js":
/*!****************************************************************!*\
  !*** ./resources/js/administrador/modulos/masiva-cms/index.js ***!
  \****************************************************************/
/*! no exports provided */
...
/* harmony import */ var _peticiones_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./peticiones.js */ "./resources/js/administrador/modulos/masiva-cms/peticiones.js");

$(function () {
  //resultMasivaCms($('#resultMasivaCms'),"","")
  loadPrincipalSaturacionDown();
  $("#filtroBasicoMasivas").click(function () {
    var jefatura = $("#listaJefaturasMasivas").val();
    var estado = $("#listaEstadosMasivas").val();
    resultMasivaCms($('#resultMasivaCms'), jefatura, estado);
  });
  $("body").on("click", ".return_masivaCms", function () {
    _peticiones_js__WEBPACK_IMPORTED_MODULE_0__["default"].redirectTabs($('#masivaCmsTab'));
  });

  function loadPrincipalSaturacionDown() {
    if ($("#filtroCuadroMando").length) {
      var motivo = "cuadroMando";
      var nodo = $("#filtroCuadroMando").val();
  ...
  function resultMasivaCms(tabla, jefatura, estado, motivo, nodo) {
    ...
    var BUTTONS_MONITOR_AVERIAS = []; //COLUMNS_MONITOR_AVERIAS = COLUMNS_MONITOR_AVERIAS_HFC

    COLUMNS_MONITOR_AVERIAS = _peticiones_js__WEBPACK_IMPORTED_MODULE_0__["default"].armandoColumnasHFC();
    BUTTONS_MONITOR_AVERIAS = BUTTONS_MONITOR_AVERIAS_HFC;
    console.log(BUTTONS_MONITOR_AVERIAS); // let filtroJefatura = jefatura;

    var parametersDataMasivas = {
      'jefatura': jefatura,
      'estado': estado,
      'motivo': motivo,
      'nodo': nodo
    };
    _peticiones_js__WEBPACK_IMPORTED_MODULE_0__["default"].cargaDataMasivaCms(COLUMNS_MONITOR_AVERIAS, COLUMNS_DEFS_MONITOR_AVERIAS, BUTTONS_MONITOR_AVERIAS, parametersDataMasivas, tabla);
  } //Maximizar
...
/***/ 80:
/*!**********************************************************************!*\
  !*** multi ./resources/js/administrador/modulos/masiva-cms/index.js ***!
  \**********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\laragon\www\new_system\resources\js\administrador\modulos\masiva-cms\index.js */"./resources/js/administrador/modulos/masiva-cms/index.js");
