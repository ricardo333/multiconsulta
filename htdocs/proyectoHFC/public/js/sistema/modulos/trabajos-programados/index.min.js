...
/***/ "./resources/js/administrador/modulos/trabajos-programados/index.js":
/*!**************************************************************************!*\
  !*** ./resources/js/administrador/modulos/trabajos-programados/index.js ***!
  \**************************************************************************/
/*! no exports provided */
...
$(function () {
  ...
  function cargaListaPrincipal() {
    var valorJefaturaTP = $("#listaJefaturasTP").val();
    var valorEstadoTP = $("#listaEstadosTP").val();
    var parametros = {
      'jefatura': valorJefaturaTP,
      "estado": valorEstadoTP
    };
  ...
  $("body").on("click", ".descargarLlamadasPorNodo", function () {
    ...
    var textoB = _this.text();

    _this.prop('disabled', true); // console.log("el texto es: ",_this.text())
    ...
    var mm = today.getMonth(mm) + 1;
    var yyyy = today.getFullYear();
    var hh = today.getHours();
    var mi = today.getMinutes();
    var ss = today.getSeconds();
    var fecha = yyyy + '' + leadingZero(mm) + '' + leadingZero(dd) + '' + leadingZero(hh) + '' + leadingZero(mi) + '' + leadingZero(ss);
    $.ajax({
      xhrFields: {
        responseType: 'blob'
      },
  ...
  $("body").on("click", ".descargarLlamadaNodoAverias", function () {
    ...
    var nodo = $(this).data("uno");
    var troba = $(this).data("dos");
    var fechaHora = $(this).data("tres");
    var trabajoProgramado = $(this).data("cuatro");
    var today = new Date();
    var dd = today.getDate();
    var mm = today.getMonth(mm) + 1;
    var yyyy = today.getFullYear();
  ...
  $("body").on("click", ".graficaLlamadasTroba", function () {
    ...
    _peticiones_js__WEBPACK_IMPORTED_MODULE_0__["default"].redirectTabs($("#graficoLlamadasTab"));
    $.ajax({
      ...
      var colores = data.response.colores;
      var grafico_data = data.response.data;
      var horaPrincipal = data.response.hora;
      var totalPrincipal = data.response.total;
      var nodoPrincipal = data.response.nodo;
      var trobaPrincipal = data.response.troba;
      ...
      var chartData = []; //console.log("El resultado de data:",grafico_data);
      ...
      Highcharts.chart("contentGraficoLlamadas", {
        ...
        subtitle: {
          useHTML: true,
          text: "<span>ULT REG: ".concat(horaPrincipal, "</span><br> \n                                                            <span>Son ").concat(totalPrincipal, " Llamadas en DMPE</span><br> \n                                                            <span> Nodo: \n                                                                    <form method=\"post\" action=\"/administrador/llamadas-troba\" class=\"d-inline\">\n                                                                        <input type=\"hidden\" name=\"_token\" value=\"").concat(tok, "\">\n                                                                        <input type=\"hidden\" name=\"nodo\" value=\"").concat(nodoPrincipal, "\">  \n                                                                        <input type=\"hidden\" name=\"grafica_llamadas_nodo_tp\" value=\"true\">\n                                                                        <button type=\"submit\" title=\"Ver Llamadas por Troba\" class=\"btn btn-link formato-link text-danger\"><b>").concat(nodoPrincipal, " - ").concat(trobaPrincipal, "</b></button>\n                                                                    </form>\n                                                            </span>")
        },
        xAxis: {
      ...
      _peticiones_js__WEBPACK_IMPORTED_MODULE_0__["default"].redirectTabs($("#listaTrabajoPTab")); // console.log("Error:",jqXHR, textStatus)
      ...
      if (jqXHR.responseJSON) {
        if (jqXHR.responseJSON.mensaje) {
          ...
          var mensaje = _globalResources_errors_js__WEBPACK_IMPORTED_MODULE_1__["default"].mensajeErrorJson(erroresMensaje); //console.log( "mensaje: " + mensaje);
      ...
      if (erroresPeticion) {
        $("#body-errors-modal").html("<div class='msg_request_error'>".concat(erroresPeticion, "</div>"));
        $('#errorsModal').modal('show');
      }
...
/***/ 90:
/*!********************************************************************************!*\
  !*** multi ./resources/js/administrador/modulos/trabajos-programados/index.js ***!
  \********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\laragon\www\new_system\resources\js\administrador\modulos\trabajos-programados\index.js */"./resources/js/administrador/modulos/trabajos-programados/index.js");
