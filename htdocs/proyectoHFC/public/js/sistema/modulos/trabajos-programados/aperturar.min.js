...
/***/ "./resources/js/administrador/modulos/trabajos-programados/aperturar.js":
/*!******************************************************************************!*\
  !*** ./resources/js/administrador/modulos/trabajos-programados/aperturar.js ***!
  \******************************************************************************/
/*! no exports provided */
...
/* harmony import */ var _peticiones_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./peticiones.js */ "./resources/js/administrador/modulos/trabajos-programados/peticiones.js");
...
$(function () {
  ...
  $("body").on("click", ".aperturarTP", function () {
    ...
    _peticiones_js__WEBPACK_IMPORTED_MODULE_0__["default"].redirectTabs($("#AperturarTrabajoProgtab"));
    $.ajax({
      url: "/administrador/trabajos-programados/".concat(item, "/detalle"),
      method: "get",
      data: {
        "formulario": "APERTURA"
      },
      ...
      $("#contentAcordionApertura").removeClass("d-none"); //console.log( "Error: " ,jqXHR, textStatus); 
      ...
      if (jqXHR.status) {
        var mensaje = _globalResources_errors_js__WEBPACK_IMPORTED_MODULE_1__["default"].codigos(jqXHR.status);
        erroresPeticion += "<strong class=\"text-danger\"> ".concat(mensaje, " </strong>");
      }
      ...
      $("#preloadAperturaTrabajoProg").html("<div class=\"w-100 text-danger justify-content-center\">".concat(erroresPeticion, "</div>"));
      return false;
    });
  });
  $("body").on("change", "#imagenAperturaSend", function () {
    ...
    if ($(this)[0].files[0]) {
      var imagen_detalle = $(this)[0].files[0]; // 
  ...
  $("body").on("click", "#aperturarTPSend", function () {
    var validacionApertura = validacionContinueApertura();
    ...
    var item = $(this).data("uno");
    var fechaDeApertura = $("#fechaAperturaSend").val();
    var hora = $("#horaAperturaSend").val();
    var tecnico = $("#tecnicoAperturaSend").val();
    var carnetTecnico = $("#carnetTecAperturaSend").val();
    var supervisorContrata = $("#supervisorContrataAperturaSend").val();
    var celSupContrata = $("#celSupContrataAperturaSend").val();
    var telefono = $("#telefonoAperturaSend").val();
    var contrata = $("#contrataAperturaSend").val();
    var observaciones = $("#observacionesAperturaSend").val();
    var imagenEstado = $('#imagenAperturaSend')[0].files[0];
    ...
    $.ajax({
      url: "/administrador/trabajos-programados/".concat(item, "/aperturar"),
      method: "post",
      async: true,
      data: formData,
      cache: false,
      ...
      $("#preloadSendAperturaTP").html(data); // return false

      $("#form_apertura_send").html("");
      $("#body-success-modal").html("<div class=\"w-100 text-center text-success\">Se apertur\xF3 correctamente el trabajo programado.</div>");
      $("#successModal").modal("show");
      _globalResources_forms_limpia_js__WEBPACK_IMPORTED_MODULE_3__["default"].limpiaFormAperturaTP();
      $("#observacionesAperturaSend").html("");
      var valorFiltroZona = $("#listaZonasFiltro").val();
      var parametros = {
        'zona': valorFiltroZona
      };
      var columnas = _peticiones_js__WEBPACK_IMPORTED_MODULE_0__["default"].armandoColumnasTP();
      _peticiones_js__WEBPACK_IMPORTED_MODULE_0__["default"].loadTrabajosProgramadosList(columnas, parametros);
      _peticiones_js__WEBPACK_IMPORTED_MODULE_0__["default"].redirectTabs($('#listaTrabajoPTab'));
    }).fail(function (jqXHR, textStatus) {
      $("#preloadSendAperturaTP").html("");
      $("#contentFormAperturaSend").removeClass("d-none"); //console.log( "Error: " ,jqXHR, textStatus);  
      ...
      if (jqXHR.responseJSON) {
        if (jqXHR.responseJSON.mensaje) {
          ...
          var _mensaje2 = _globalResources_errors_js__WEBPACK_IMPORTED_MODULE_1__["default"].mensajeErrorJson(erroresMensaje);
  ...
  function validacionContinueApertura() {
    var fechaAperturaSend = $("#fechaAperturaSend");
    var horaAperturaSend = $("#horaAperturaSend");
    var tecnicoAperturaSend = $("#tecnicoAperturaSend");
    var celSupContrataAperturaSend = $("#celSupContrataAperturaSend");
    var telefonoAperturaSend = $("#telefonoAperturaSend");
    var contrataAperturaSend = $("#contrataAperturaSend");
    var imagenEstado = $('#imagenAperturaSend')[0].files[0] || "";
    $(".validateText").removeClass("valida-error-input");
    $(".validateSelect").removeClass("valida-error-input");
    $("#errorValidacionApertura").html("");

    if (!_globalResources_forms_valida_js__WEBPACK_IMPORTED_MODULE_2__["default"].isValidText(fechaAperturaSend.val())) {
      _globalResources_forms_valida_js__WEBPACK_IMPORTED_MODULE_2__["default"].isValidateInputText(fechaAperturaSend);
      $("#errorValidacionApertura").html("El campo Fecha Apertura es requerida");
      return false;
    }

    if (!_globalResources_forms_valida_js__WEBPACK_IMPORTED_MODULE_2__["default"].isValidText(horaAperturaSend.val())) {
      _globalResources_forms_valida_js__WEBPACK_IMPORTED_MODULE_2__["default"].isValidateInputText(horaAperturaSend);
      $("#errorValidacionApertura").html("El campo Hora Apertura es requerida");
      return false;
    }

    if (tecnicoAperturaSend.val().toLowerCase() == "seleccionar") {
      _globalResources_forms_valida_js__WEBPACK_IMPORTED_MODULE_2__["default"].isValidateInputText(tecnicoAperturaSend);
      $("#errorValidacionApertura").html("Seleccione un t\xE9cnico v\xE1lido");
      return false;
    }

    if (celSupContrataAperturaSend.val() != "") {
      if (!_globalResources_forms_valida_js__WEBPACK_IMPORTED_MODULE_2__["default"].isValidNumber(celSupContrataAperturaSend.val())) {
        _globalResources_forms_valida_js__WEBPACK_IMPORTED_MODULE_2__["default"].isValidateInputText(celSupContrataAperturaSend);
        $("#errorValidacionApertura").html("El campo Celular Supervisor Contrata debe ser de formato num\xE9rico");
        return false;
      }
    ...
    if (telefonoAperturaSend.val() != "") {
      if (!_globalResources_forms_valida_js__WEBPACK_IMPORTED_MODULE_2__["default"].isValidNumber(telefonoAperturaSend.val())) {
        _globalResources_forms_valida_js__WEBPACK_IMPORTED_MODULE_2__["default"].isValidateInputText(telefonoAperturaSend);
        $("#errorValidacionApertura").html("El campo Telefono T\xE9cnico debe ser de formato num\xE9rico");
        return false;
      }

      if (telefonoAperturaSend.val().length > 10 || telefonoAperturaSend.val().length < 7) {
        _globalResources_forms_valida_js__WEBPACK_IMPORTED_MODULE_2__["default"].isValidateInputText(telefonoAperturaSend);
        $("#errorValidacionApertura").html("El campo Telefono T\xE9cnico debe tener una logintud entre [7 - 10]");
        return false;
      }
    }

    if (contrataAperturaSend.val().toLowerCase() == "seleccionar") {
      _globalResources_forms_valida_js__WEBPACK_IMPORTED_MODULE_2__["default"].isValidateInputText(contrataAperturaSend);
      $("#errorValidacionApertura").html("Seleccione una Contrara v\xE1lida");
      return false;
    }

    if (imagenEstado == "") {
      _globalResources_forms_valida_js__WEBPACK_IMPORTED_MODULE_2__["default"].isValidateInputText($("#info_detalle_imagenApertura"));
...
/***/ "./resources/js/administrador/modulos/trabajos-programados/peticiones.js":
/*!*******************************************************************************!*\
  !*** ./resources/js/administrador/modulos/trabajos-programados/peticiones.js ***!
  \*******************************************************************************/
...
peticiones.armandoColumnasTP = function armandoColumnasTP() {
  var columnasTemporales = [];
  var APER_CERR_CANC_COLUMNA_PERMISO = APERTURAR_TP_PERMISO || CERRAR_TP_PERMISO || CANCELAR_TP_PERMISO;

  if (APER_CERR_CANC_COLUMNA_PERMISO || GESTION_INDIV_PERMISO || DESCARGAR_CLIENTES_PERMISO) {
    columnasTemporales.push({
      data: 'id',
      render: function render(data, type, row) {
        var estructuraAcciones = "";
        ...
        if (APER_CERR_CANC_COLUMNA_PERMISO) {
          if ((row.ESTADO == "CERRADO" || row.ESTADO == "ENPROCESO") && GESTION_INDIV_PERMISO) {
            ...
            estructuraAcciones += "<a href=\"javascript:void(0)\" class=\"btn btn-sm btn-light p-0 gestionarTrabajoProg\" \n                                                data-uno=\"".concat(row.NODO, "\" data-dos=\"").concat(row.TROBA, "\" data-tres=\"0\"\n                                                data-cuatro=\"\" data-cinco=\"").concat(row.codreqmnt, "\" data-seis=\"Liquidacion\"\n                                                data-siete=").concat(row.ITEM, " style=\"color:").concat(row.gestionRegistroColor, ";\" alt=\"Gestionar Trabajo Programado\" title=\"Gestionar Trabajo Programado\">\n                                                    <i class=\"icofont-list icofont-2x\"></i>    \n                                            </a>");
          }

          if (row.ESTADO == "PENDIENTE") {
            if (APERTURAR_TP_PERMISO) {
              estructuraAcciones += " <a href=\"javascript:void(0)\" class=\"btn shadow-sm p-0 aperturarTP\" data-uno=\"".concat(row.ITEM, "\">\n                                                        <img class=\"img\" src=\"/images/icons/apertura.png\" />\n                                                    </a>");
            }

            if (CANCELAR_TP_PERMISO) {
              estructuraAcciones += "<a href=\"javascript:void(0)\" class=\"btn shadow-sm p-0 cancelarTP\" data-uno=\"".concat(row.ITEM, "\">\n                                                    <img class=\"img\" src=\"/images/icons/cancelar.png\" />\n                                                    </a>");
            }
          }

          if (row.ESTADO == "ENPROCESO") {
            if (CERRAR_TP_PERMISO) {
              estructuraAcciones += " <a href=\"javascript:void(0)\" class=\"btn shadow-sm p-0 cerrarTP\" data-uno=\"".concat(row.ITEM, "\">\n                                                    <img class=\"img\" src=\"/images/icons/cierre.png\" />\n                                                </a>");
            }

            if (DESCARGAR_CLIENTES_PERMISO) {
              estructuraAcciones += "<button  class=\"btn shadow-sm p-0 descargarClienteTP\" data-uno=\"".concat(row.ITEM, "\" \n                                                        data-dos=\"").concat(row.NODO, "\" data-tres=\"").concat(row.TROBA, "\" style=\"color:").concat(row.colorIcon, ";\" alt=\"Descargar Clientes de TP\" title=\"Descargar Clientes de TP\">\n                                                            <i class=\"icofont-file-excel icofont-2x\"></i>\n                                                </button>");
            }
          }
  ...
  columnasTemporales.push({
    ...
    render: function render(data, type, row) {
      ...
      if (row.calls != null) {
        btnCall += "<button class=\"descargarLlamadasPorNodo\" data-uno=\"".concat(row.NODO, "\" \n                                                data-dos=\"").concat(row.TROBA, "\" data-tres=\"").concat(row.fechattpp, "\">\n                                        ").concat(row.calls, "\n                                    </button>");
      }

      return "\n                    ".concat(btnCall, "\n                    <button class=\"bg-transparent border-0 graficaLlamadasTroba\" data-uno=\"").concat(row.NODO, "\" data-dos=\"").concat(row.TROBA, "\">\n                        <img src=\"/images/icons/trabajos-programados/").concat(data, "\" alt='Seguir' width=20 height=20 border=0>\n                    </button>\n                ");
    }
  }, {
    data: null,
    render: function render(data, type, row) {
      if (row.cpend != null) {
        return "\n                            <button class=\"d-block m-auto descargarLlamadaNodoAverias\" data-uno=\"".concat(row.NODO, "\" \n                                        data-dos=\"").concat(row.TROBA, "\" data-tres=\"").concat(row.fechattpp, "\" data-cuatro=\"1\">\n                                ").concat(row.cpend == null ? "" : row.cpend, "\n                            </button>\n                        ");
      } else {
        return "";
      }
    }
    ...
    data: 'NODO',
    render: function render(data, type, row) {
      return "".concat(row.NODO, " - ").concat(row.TROBA);
    }
  }, {
    data: 'jefatura',
    render: function render(data, type, row) {
      return "".concat(data == null ? "" : data);
    }
  }, {
    data: 'AMP'
  }, {
    ...
    data: 'FINICIO',
    render: function render(data, type, row) {
      return "".concat(row.FINICIO, " De:  ").concat(row.HINICIO, " a ").concat(row.HTERMINO);
    }
  }, {
    data: 'CORTESN'
  }, {
    ...
    render: function render(data, type, row) {
      if (data != "" && data != null) {
        return "<img class=\"imagenes_ttpp_aper_cierre\" src=\"/images/upload/trabajos-programados/".concat(row.IMAGENAPERTURA, "\"\n                            data-uno=\"/images/upload/trabajos-programados/").concat(row.IMAGENAPERTURA, "\" data-dos=\"Imagen de Apertura\"\n                            alt=\"Detalle Imagen Apertura\" title=\"Detalle Imagen Apertura\"\n                        />  ");
      } else {
        return "";
      }
    }
    ...
    render: function render(data, type, row) {
      if (data != "" && data != null) {
        return "<img class=\"imagenes_ttpp_aper_cierre\" src=\"/images/upload/trabajos-programados/".concat(row.IMAGENCIERRE, "\"\n                            data-uno=\"/images/upload/trabajos-programados/").concat(row.IMAGENCIERRE, "\" data-dos=\"Imagen de Cierre\"\n                            alt=\"Detalle Imagen Apertura\" title=\"Detalle Imagen Apertura\"\n                        />  ");
      } else {
        return "";
      }
    }
...
peticiones.loadTrabajosProgramadosList = function loadTrabajosProgramadosList(COLUMNAS, parametros) {
  ...
  $("#resultTrabajosProg").DataTable({
    ...
    "processing": true,
    "serverSide": true,
    "dom": '<"row mx-0"' + '<"col-12 col-sm-6"l><"col-12 col-sm-6 text-right"B>>' + '<"row"' + '<"col-sm-12 px-0 table-responsive"t>>' + '<"row"' + '<"col-12 col-sm-5"i><"col-12 col-sm-7"p>>' + 'r',
    "buttons": [{
      text: 'DESCARGAS',
    ...
    "ajax": {
      ...
      'error': function error(jqXHR, textStatus, errorThrown) {
        ...
        if (jqXHR.status) {
          ...
          erroresPeticion = mensaje; // console.log("el mensaje re error codigos es: ",erroresPeticion)
        }
    ...
    "initComplete": function initComplete() {
      ...
      var primera_col = $('.tableFixHead tbody tr td:nth-child(1)');
...
/***/ 93:
/*!************************************************************************************!*\
  !*** multi ./resources/js/administrador/modulos/trabajos-programados/aperturar.js ***!
  \************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\laragon\www\new_system\resources\js\administrador\modulos\trabajos-programados\aperturar.js */"./resources/js/administrador/modulos/trabajos-programados/aperturar.js");
